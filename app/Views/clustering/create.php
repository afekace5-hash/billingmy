...
<?= $this->section('title') ?>
<title>Tambah Cluster - Billingkimo</title>
<?= $this->endSection() ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Tambah Cluster Baru</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="clusterForm" action="<?= site_url('clustering/store') ?>" method="POST">
                            <?= csrf_field() ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="address" id="address" rows="3"
                                    placeholder="Masukkan alamat lengkap cluster (Jalan, RT/RW, Kelurahan, dll)"></textarea>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="submit" id="saveBtn" class="btn btn-success">
                                    <i class="bx bx-save"></i> Simpan Cluster
                                </button>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function initMap() {
        ...
        try {
            // Default koordinat (Desa Lebo, Kec. Gringsing, Batang)
            const defaultLat = -6.9382;
            const defaultLng = 109.7190;
    ...
    $(document).ready(function() {
        ...
        $('#clusterForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                complete: function() {
                    $btn.prop('disabled', false).html('<i class="bx bx-save"></i> Simpan Cluster');
                }
            });
        });
